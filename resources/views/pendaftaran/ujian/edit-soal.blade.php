...
<ol class="breadcrumb">
    <li class="breadcrumb-item">Ujian Calon Siswa</li>
...
<div class="intro-y box p-5 mt-5">
    <form
        action="{{ route('soalCalon.update', ['soal' => $soal->id]) }}"
        method="POST"
    >
        @csrf
        @method('PUT')
