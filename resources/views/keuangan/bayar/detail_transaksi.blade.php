                    ...
                    <div class="mb-5">
                      ...
                      <input
                        ...
                        <div class="flex items-center gap-3 mb-3">
                            <label class="w-32 text-sm font-medium">NIPD</label>
...
@include('keuangan.bayar.modal_detail.modal_tambah')
@include('keuangan.bayar.modal_detail.modal_update_history')
