            ...
            <div class="block xl:grid grid-cols-2 gap-4">
                ...
                <div class="hidden xl:flex flex-col min-h-screen">
                    ...
                    <div class="my-auto">
                        ...
                        <div class="-intro-x mt-5 text-lg text-white text-opacity-70 dark:text-slate-400">SISTEM INFORMASI SEKOLAH</div>
                    </div>
                </div>
                <!-- END: Login Info -->
                <!-- BEGIN: Login Form -->
                <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                    <div class="my-auto mx-auto xl:ml-20 bg-white dark:bg-darkmode-600 xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
                        ...
                        @endif
                        <div class="intro-x mt-2 text-slate-400 xl:hidden text-center">A few more clicks to sign in to your account. SISTEM INFORMASI GURU</div>
                        <form action="{{route('login')}}" method="post">
                            @csrf
                            <div class="intro-x mt-8">
                                <input type="email" value="{{old('email')}}" name="email" class="intro-x login__input form-control py-3 px-4 block" placeholder="Email">
                                <input type="password" name="password" class="intro-x login__input form-control py-3 px-4 block mt-4" placeholder="Password">
                            </div>
                            <div class=" mt-4 captcha-desain">
                            ...
                            <div class="intro-x mt-5 xl:mt-8 text-center xl:text-center">
                                ...
                                <a href="https://smam1denpasar.sch.id" class="btn btn-outline-secondary py-3 px-4 w-full xl:w-32 mt-3 xl:mt-0 align-top">Home</a>
                            </div>
                        </form>
